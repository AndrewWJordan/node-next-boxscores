...
<div className={styles.boxscore}>
    <table className={`${styles.table} boxscore__team boxscore__team--header`}>
    ...
    <div className={styles.boxscore__details}>
      <div className={`${styles.boxscore__details__team} boxscore__details__team--away`}>
        <p>
          <strong>Cubs</strong>
          <small>CHC</small>
        </p>
      ...
      <div className={`${styles.boxscore__details__team} boxscore__details__team--home`}>
        <p>
